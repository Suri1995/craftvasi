...
export default function AboutPage() {
  ...
  return (
    <main>
      ...
      {/* Hero Section */}
      <section className="pt-30 pb-16 md:pb-24 bg-gradient-to-b from-[#050539] via-[#151547] to-[#2d2d5f]">
...
>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    <div className="max-w-4xl mx-auto relative">
      ...
      <div className="absolute left-[27px] top-0 bottom-0 w-px md:hidden"
        style={{ background: "linear-gradient(to bottom, hsl(var(--accent)), hsl(var(--accent)/0.3), transparent)" }}
      />
      ...
      <div className="space-y-12 relative" style={{ zIndex: 1 }}>
        {[
          ...
          },
          {
            ...
            description: "Successfully completed over 200+ projects, marking a significant milestone in our growth and reputation for excellence.",
            icon: (
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          },
          {
            ...
            description: "Expanded operations with a new office and growing team in B.N. Reddy Nagar, Hyderabad, to better serve our valued clients.",
            icon: (
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          return (
            <div
              key={index}
              ref={(el) => { if (el) sectionsRef.current[index + 7] = el; }}
              className={`scroll-reveal ${visibleSections.includes(index + 7) ? "is-visible" : ""}`}
              style={{ transitionDelay: `${index * 120}ms` }}
            >
              <div className={`group flex items-center gap-0 md:gap-8
                ${isRight ? "flex-row" : "flex-row md:flex-row-reverse"}`}>

                {/* Card */}
                <div className={`flex-1 relative bg-white/55 backdrop-blur-sm border border-accent/15 rounded-3xl p-7 overflow-hidden
                  transition-all duration-500
                  hover:-translate-y-1
                  hover:border-accent/50
                  hover:shadow-2xl hover:shadow-accent/10
                  ...
                  {/* Corner glow */}
                  <div className={`absolute -top-8 w-32 h-32 bg-accent/0 rounded-full blur-2xl
                    group-hover:bg-accent/15 transition-all duration-500
                    ${isRight ? "-right-8" : "-left-8"}`} />

                  {/* Year badge + line */}
                  <div className="flex items-center gap-3 mb-4">
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold tracking-widest bg-accent/10 text-accent border border-accent/20
                  ...
                  {/* Animated underline */}
                  <div className="w-8 h-1 bg-accent/40 rounded-full mb-4
...
},
{
  ...
  tags: ["Operations", "Strategy", "Delivery"],
        ...
        <div
          key={index}
          ref={(el) => { if (el) sectionsRef.current[index + 12] = el; }}
          className={`scroll-reveal h-full ${visibleSections.includes(index + 12) ? "is-visible" : ""}`}
          style={{ transitionDelay: `${index * 150}ms` }}
        >
          <div className="group relative bg-white/55 backdrop-blur-sm border border-accent/15 rounded-3xl overflow-hidden h-full flex flex-col
            transition-all duration-500
            hover:-translate-y-2
            ...
            {/* Corner glow */}
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-accent/0 rounded-full blur-2xl
              group-hover:bg-primary/15 transition-all duration-500" />

            {/* Avatar area */}
            <div className="relative h-56 flex-shrink-0 bg-gradient-to-br from-accent/10 via-accent/5 to-primary/10 flex items-center justify-center overflow-hidden
              ...
              {/* Decorative rings */}
              <div className="absolute w-36 h-36 rounded-full border-2 border-accent/10
                group-hover:border-primary/30 group-hover:scale-110 transition-all duration-500" />
              <div className="absolute w-48 h-48 rounded-full border border-accent/5
                group-hover:border-primary/15 group-hover:scale-110 transition-all duration-700" />

              {/* Floating particles */}
              <div className="absolute top-4 left-8 w-2 h-2 rounded-full bg-accent/30
              ...
              <div className="absolute bottom-8 left-16 w-1 h-1 rounded-full bg-accent/25
                group-hover:bg-primary/35 group-hover:-translate-y-1 transition-all duration-600" />

              {/* Avatar circle */}
              <div className="relative w-28 h-28 rounded-2xl bg-white/80 border-2 border-accent/20 flex items-center justify-center
                group-hover:bg-primary group-hover:border-primary group-hover:scale-105 group-hover:rotate-3
                transition-all duration-300 shadow-xl shadow-accent/10 group-hover:shadow-primary/30 z-10">
                <span className="text-3xl font-heading font-bold text-accent group-hover:text-white transition-colors duration-300">
                  {leader.initials}
                </span>
              </div>
            ...
            <div className="p-8 relative flex flex-col flex-1">
              ...
              {/* Name + role */}
              <div className="mb-4">
                <h3 className="text-xl md:text-2xl font-heading font-bold text-primary mb-1.5
                  group-hover:text-accent transition-colors duration-300">
                  {leader.name}
                </h3>
              ...
              {/* Animated underline */}
              <div className="w-10 h-1 bg-accent/40 rounded-full mb-5
                group-hover:w-20 group-hover:bg-primary transition-all duration-500" />

              {/* Description */}
              <p className="text-foreground/65 leading-relaxed text-sm mb-6 flex-1
                group-hover:text-foreground/90 transition-colors duration-300">
                {leader.background}
              </p>
